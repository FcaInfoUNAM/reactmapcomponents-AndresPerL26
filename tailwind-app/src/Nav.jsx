    ...
    <div className="hidden w-full md:block md:w-auto" id="navbar-default">
      <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
        {navigation.map(e=>
          ...
          /*El método map() en este caso itera sobre el array 'navigation', creando un elemento <li> 
          por cada objeto en el array. Para cada elemento 'e' del array:
          Crea un enlace <a> con:
            - href tomado de e.href
            - className condicional basado en e.available (si es true usa un estilo, si es false otro)
            - El texto del enlace viene de e.title*/
        )}     
      </ul>
    </div>
  </div>
